...
import vulnerabilityExecutiveDescriptor from './vulnerabilityExecutiveDescriptor';
...
const templateMapper: {
  ...
  [ServiceNames.vulnerabilityExecutive]: prepareServiceCall(vulnerabilityExecutiveDescriptor),
};
